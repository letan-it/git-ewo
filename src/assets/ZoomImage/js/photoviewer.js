  ...
  var PhotoViewer = /*#__PURE__*/function () {
    ...
    _createClass(PhotoViewer, [{
      ...
      value: function setModalSize(img) {
        ...
        var modalCSSObj = {
          width: '500px',// minWidth + 'px',
          height: '700px',// minHeight + 'px',
          left: (winWidth - 500) / 2 + scrollLeft + 500 + 'px',// (winWidth - minWidth) / 2 + scrollLeft + 300 + 'px',
          top: '20px'// (winHeight - minHeight) / 2 + scrollTop + 'px'
