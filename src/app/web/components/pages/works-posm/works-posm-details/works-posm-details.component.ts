...
@Component({
    selector: 'app-works-posm-details',
    templateUrl: './works-posm-details.component.html',
    styleUrls: ['./works-posm-details.component.scss'],
    providers: [MessageService, ConfirmationService],
})
export class WorksPosmDetailsComponent implements OnInit {
    constructor(
        ...
        private posmService: PosmService,
