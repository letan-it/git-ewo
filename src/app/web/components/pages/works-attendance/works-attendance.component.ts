...
@Component({
    selector: 'app-works-attendance',
    templateUrl: './works-attendance.component.html',
    styleUrls: ['./works-attendance.component.scss'],
})
export class WorksAttendanceComponent {
    items_menu: any = [
        { label: ' REPORT' },
        {
            label: ' Works Attendance',
            icon: 'pi pi-table',
        },
    ];
    ...
    GetPerDownloadExcel1() {
        ...
        // console.log('GetPerDownloadExcel - this.itemsData - HOA TEST : ', this.itemsData)
    ...
    export() {
        ...
        console.log('this.shop_name :', this.shop_name);
