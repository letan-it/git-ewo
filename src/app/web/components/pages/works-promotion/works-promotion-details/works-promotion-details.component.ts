...
@Component({
    selector: 'app-works-promotion-details',
    templateUrl: './works-promotion-details.component.html',
    styleUrls: ['./works-promotion-details.component.scss'],
    providers: [ConfirmationService, DatePipe, MessageService],
})
export class WorksPromotionDetailsComponent implements OnInit {
    constructor(
