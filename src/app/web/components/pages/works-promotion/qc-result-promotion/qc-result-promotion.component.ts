...
@Component({
  selector: 'app-qc-result-promotion',
  templateUrl: './qc-result-promotion.component.html',
  styleUrls: ['./qc-result-promotion.component.scss'],
  providers: [MessageService, ConfirmationService],
})
export class QcResultPromotionComponent {
