...
@Component({
  selector: 'app-works-osa-details',
  templateUrl: './works-osa-details.component.html',
  styleUrls: ['./works-osa-details.component.scss'],
  providers: [MessageService, ConfirmationService],
})
export class WorksOsaDetailsComponent implements OnInit {
  constructor(
