...
@Component({
  selector: 'app-works-osa',
  templateUrl: './works-osa.component.html',
  styleUrls: ['./works-osa.component.scss'],
  providers: [MessageService, ConfirmationService],
})
export class WorksOsaComponent {
  items_menu: any = [
    { label: ' REPORT' },
    {
      label: ' Works OSA',
  ...
  export() {
    ...
    this.serviceExport.ewo_Report_GetRawData_OSA(
      this.totalRecords,
      1,
      Helper.ProjectID(),
      this.item_SS,
