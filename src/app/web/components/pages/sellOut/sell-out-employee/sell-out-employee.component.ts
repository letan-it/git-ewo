...
@Component({
    selector: 'app-sell-out-employee',
    templateUrl: './sell-out-employee.component.html',
    styleUrls: ['./sell-out-employee.component.scss'],
    providers: [MessageService, ConfirmationService],
})
export class SellOutEmployeeComponent {
        ...
        this._service
            ...
            .subscribe((data: any) => {
                if (data.result == EnumStatus.ok) {
                    this.listSellOutEmployee = data.data;
                    this.listSellOutEmployee = this.listSellOutEmployee.map(
                        (t: any) => ({
                            ...t,
                    ...
                    this.totalRecords =
                        this.listSellOutEmployee.length > 0
                            ? this.listSellOutEmployee[0].TotalRows
                            : 0;
                    this.loading = false;
                } else {
                    this.listSellOutEmployee = [];
                    this.loading = false;
                }
            });
    }
    ...
    export() {
        this._service.SellOut_Employee_RawData(
            Helper.ProjectID(),
    ...
    getTemplate() {
        this._service.SellOut_Employee_GetTemplate(Helper.ProjectID());
    }
    importTemplate() {
        if (
    ...
    exportExcel() {
        import('xlsx').then((xlsx) => {
            ...
            this.saveAsExcelFile(excelBuffer, 'EmployeeAction');
        });
    }
