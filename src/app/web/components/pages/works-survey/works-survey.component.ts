...
@Component({
  selector: 'app-works-survey',
  templateUrl: './works-survey.component.html',
  styleUrls: ['./works-survey.component.scss'],
  providers: [MessageService, ConfirmationService],
})
export class WorksSurveyComponent {
  items_menu: any = [
    { label: ' REPORT' },
    {
      label: ' Works Survey',
  ...
  filter(pageNumber: number) {
    ...
    this._service
      .ewo_ReportGetList_Survey(
        ...
        -1,
        this.item_ASM,
        this.uuid, this.item_SurveyReport + ''
      )
      .subscribe((data: any) => {
        this.is_loadForm = 0;
        if (data.result == EnumStatus.ok) {
