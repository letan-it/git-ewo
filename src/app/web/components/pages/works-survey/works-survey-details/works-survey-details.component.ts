...
@Component({
  selector: 'app-works-survey-details',
  templateUrl: './works-survey-details.component.html',
  styleUrls: ['./works-survey-details.component.scss'],
  providers: [MessageService, ConfirmationService],
})
export class WorksSurveyDetailsComponent implements OnInit {
        ...
        .subscribe((data: any) => {
          ...
          if (data.result == EnumStatus.ok) {
            ...
            if (Helper.IsNull(dataLatitude) != true && Helper.IsNull(dataLongitude) != true) {
              ...
              // In ra khoảng cách
              // console.log("Khoảng cách giữa hai tọa độ GPS là: " + distance.toFixed(2) + " km");
              ...
              this.inValue.data_osa.osA_Results.forEach(
                (element: any) => {
                  ...
                  try {
                    // element.his = JSON.parse(element.his);
                    // element.now_value = element.values;
                    // element.now_reason_name =  element.reason_name;
