...
@Component({
    selector: 'app-works-survey-form-default',
    templateUrl: './works-survey-form-default.component.html',
    styleUrls: ['./works-survey-form-default.component.scss'],
})
export class WorksSurveyFormDefaultComponent {
    constructor(
