...
@Component({
  selector: 'app-works-survey-form-fixture',
  templateUrl: './works-survey-form-fixture.component.html',
  styleUrls: ['./works-survey-form-fixture.component.scss']
})
export class WorksSurveyFormFixtureComponent {
  constructor(
