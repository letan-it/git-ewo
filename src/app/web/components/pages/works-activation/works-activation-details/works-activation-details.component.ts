...
@Component({
  selector: 'app-works-activation-details',
  templateUrl: './works-activation-details.component.html',
  styleUrls: ['./works-activation-details.component.scss']
})
export class WorksActivationDetailsComponent {
  constructor(
  ...
  loadItemKPI() {
    ...
    // } catch (error) {}
    try {
      this.loadDataSOS(Helper.ProjectID(), this.inValue.report_id);
    } catch (error) { }
    try {
      this.getListProduct();
      this.loadMaster();
    ...
    this.sosService
      ...
      .subscribe((data: any) => {
        if (data.result == EnumStatus.ok) {
          ...
          // console.log('this.inValue.data_sos', this.inValue.data_sos)
