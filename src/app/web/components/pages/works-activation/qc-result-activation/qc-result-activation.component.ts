...
@Component({
  selector: 'app-qc-result-activation',
  templateUrl: './qc-result-activation.component.html',
  styleUrls: ['./qc-result-activation.component.scss']
})
export class QcResultActivationComponent {
  constructor(
