...
@Component({
    selector: 'app-works-sos-details',
    templateUrl: './works-sos-details.component.html',
    styleUrls: ['./works-sos-details.component.scss'],
    providers: [MessageService, ConfirmationService],
})
export class WorksSosDetailsComponent implements OnInit {
    constructor(
