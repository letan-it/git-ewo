...
@Component({
  selector: 'app-works-sellin-detail',
  templateUrl: './works-sellin-detail.component.html',
  styleUrls: ['./works-sellin-detail.component.scss'],
  providers: [MessageService, ConfirmationService],
})
export class WorksSellinDetailComponent implements OnInit {
  constructor(
  ...
  resetLoadTotal(event: any) {
    console.log('resetLoadTotal -> WORK DETAILS', event)
