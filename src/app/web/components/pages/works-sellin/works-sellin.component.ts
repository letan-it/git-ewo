...
@Component({
  selector: 'app-works-sellin',
  templateUrl: './works-sellin.component.html',
  styleUrls: ['./works-sellin.component.scss']
})
export class WorksSellinComponent {
  items_menu: any = [
    { label: ' REPORT' },
    {
      label: ' Works Sell In ',
  ...
  resetLoadTotal(event: any) {
    console.log('resetLoadTotal : SELLOUT IN ', event)
