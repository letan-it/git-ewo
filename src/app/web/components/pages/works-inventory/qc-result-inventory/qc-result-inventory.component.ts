...
@Component({
  selector: 'app-qc-result-inventory',
  templateUrl: './qc-result-inventory.component.html',
  styleUrls: ['./qc-result-inventory.component.scss']
})
export class QcResultInventoryComponent {
  constructor(
