...
@Component({
  selector: 'app-works-inventory-details',
  templateUrl: './works-inventory-details.component.html',
  styleUrls: ['./works-inventory-details.component.scss']
})
export class WorksInventoryDetailsComponent {
  constructor(
