...
@Component({
    selector: 'app-ool',
    templateUrl: './ool.component.html',
    styleUrls: ['./ool.component.scss'],
    providers: [ConfirmationService, DatePipe, MessageService],
})
export class OolComponent {
    @Input() inValue: any;
    ...
    openDelete(item?: any, tab?: any) {
        this.confirmationService.confirm({
            ...
            accept: () => {
                this._service
                    .OOL_Detail_Action(Helper.ProjectID(), item.ool_detail_id)
                    .subscribe((data: any) => {
    ...
    openClone(item?: any, tab?: any) {
        this.confirmationService.confirm({
            // target: event.target as EventTarget,
            message: 'Are you sure you want to clone it?',
            icon: 'pi pi-exclamation-triangle',
            accept: () => {
                this._service
                    .OOL_Detail_Clone(Helper.ProjectID(), item.ool_detail_id)
                    .subscribe((data: any) => {
                        if (data.result == EnumStatus.ok) {
                            this.messageService.add({
                                severity: 'success',
                                summary: 'Clone detail successfully',
                                detail: '',
                            });
                            this.clearAction(tab);
                        } else {
    ...
    loadMaster() {
        this._service
            ...
            .subscribe((data: any) => {
                ...
                // console.log('listItemMaster : ', this.listItemMaster)
            });
    }
