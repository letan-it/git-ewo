...
@Component({
  selector: 'app-qc-result-sellout',
  templateUrl: './qc-result-sellout.component.html',
  styleUrls: ['./qc-result-sellout.component.scss'],
  providers: [ConfirmationService, MessageService],
})
export class QcResultSelloutComponent {
  constructor(
